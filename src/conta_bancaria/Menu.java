...
public class Menu {
	...
	public static void main(String[] args) {
		...
		ContaCorrente cc1 = new ContaCorrente(3, 789, 1, "Mariana", 123.45f, 20000.00f);
		cc1.visualizar();
		
		System.out.println("Sacar R$ 1.000,00 da conta corrente 1: "+ (cc1.sacar(1000.00f) ? "Saque efetuado com sucesso. Saldo: "+cc1.getSaldo() : "Saldo insuficiente."));
		System.out.println("Sacar R$ 1.000,00 da conta corrente 1: "+ (cc1.sacar(300000.00f) ? "Saque efetuado com sucesso. Saldo: "+cc1.getSaldo() : "Saldo insuficiente."));
