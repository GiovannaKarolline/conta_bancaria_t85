...
1. Clone o repositório do Projeto [Conta Bancária](https://github.com/giovannakarolline/conta_bancaria) dentro da pasta do *Workspace* do Eclipse/STS

```bash
git clone https://github.com/giovannakarolline/conta_bancaria.git
```
...
Desenvolvido por [**Giovanna**](https://github.com/GiovannaKarolline)
